...
} from "../controllers/auth.controllers.js"; // importing the signupController, loginController, logoutController, and meController functions from the auth.controllers.js file
